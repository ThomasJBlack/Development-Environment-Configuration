# NOTE: if certain zsh plugins are not installed this file will not be all you need.
# MAINTAINER TODO: add a script to install all the plugins and dependencies
...
# git diff of file names only from current and $1 branch
function gdn() {
  git diff --name-only $1
}
alias co="code ."

# dato (marketing site aliases) (REMOVE ME WHEN WE'RE DONE WITH THE MARKETING SITE)
function dato() {
  find .env -type f -exec sed -i '' -e "/^NEXT_DATOCMS_ENVIRONMENT=/s/=.*/=$1/" {} \;
...
export PATH=$PATH:/Users/$USER_PATH/Library/Python/3.9/bin
...
# bun completions
[ -s "/Users/$USER_PATH/.bun/_bun" ] && source "/Users/$USER_PATH/.bun/_bun"

# bun
export BUN_INSTALL="$HOME/.bun"
export PATH="$BUN_INSTALL/bin:$PATH"

# HISTFILE="$HOME/.zsh_history.$(echo $$)"
